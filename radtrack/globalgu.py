...
class Ui_globalgu(object):
    def setupUi(self, globalgu):
        ...
        self.actionSetLocation = QtGui.QAction(globalgu)
        self.actionSetLocation.setObjectName("actionSetLocation")
        self.actionNewInstance = QtGui.QAction(globalgu)
        self.actionNewInstance.setObjectName("actionNewInstance")
        ...
        self.menuFile.addAction(self.actionSetLocation)
        self.menuFile.addAction(self.actionNewInstance)
    ...
    def retranslateUi(self, globalgu):
        ...
        self.actionSetLocation.setText(QtGui.QApplication.translate("globalgu", "Set Current Project Location ...", None, QtGui.QApplication.UnicodeUTF8))
        self.actionNewInstance.setText(QtGui.QApplication.translate("globalgu", "Open New RadTrack Window ...", None, QtGui.QApplication.UnicodeUTF8))
