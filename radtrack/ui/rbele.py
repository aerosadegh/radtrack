...
#
# Created: Fri May 27 05:24:59 2016
...
class Ui_ELE(object):
    def setupUi(self, ELE):
        ...
        self.gridLayout_4.addWidget(self.abortButton, 1, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.simulateButton, 1, 0, 1, 1)
        self.numProcLabel = QtGui.QLabel(self.layoutWidget_2)
        self.numProcLabel.setObjectName(_fromUtf8("numProcLabel"))
        self.gridLayout_4.addWidget(self.numProcLabel, 0, 0, 1, 1)
        ...
        self.numProcSlider.setMinimum(1)
        self.numProcSlider.setMaximum(1)
        self.numProcSlider.setPageStep(2)
        self.numProcSlider.setProperty("value", 1)
        ...
        self.gridLayout_4.addWidget(self.numProcSlider, 0, 1, 1, 1)
    ...
    def retranslateUi(self, ELE):
        ...
        self.numProcLabel.setText(_translate("ELE", "Number of Processes: 1", None))
