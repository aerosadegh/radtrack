...
class Ui_LaserInterface(object):
    def setupUi(self, LaserInterface):
        ...
        LaserInterface.resize(639, 519)
        self.gridLayout_2 = QtGui.QGridLayout(LaserInterface)
        ...
        self.gridLayout.addWidget(self.noTitles, 0, 1, 1, 1)
        self.generatePulse = QtGui.QToolButton(LaserInterface)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.generatePulse.sizePolicy().hasHeightForWidth())
        self.generatePulse.setSizePolicy(sizePolicy)
        self.generatePulse.setToolTip(_fromUtf8(""))
        self.generatePulse.setObjectName(_fromUtf8("generatePulse"))
        self.gridLayout.addWidget(self.generatePulse, 0, 0, 1, 1)
        self.externalFields = QtGui.QToolButton(LaserInterface)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.externalFields.sizePolicy().hasHeightForWidth())
        self.externalFields.setSizePolicy(sizePolicy)
        self.externalFields.setObjectName(_fromUtf8("externalFields"))
        self.gridLayout.addWidget(self.externalFields, 1, 0, 1, 1)
        self.generateCoeffs = QtGui.QToolButton(LaserInterface)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.generateCoeffs.sizePolicy().hasHeightForWidth())
        self.generateCoeffs.setSizePolicy(sizePolicy)
        self.generateCoeffs.setObjectName(_fromUtf8("generateCoeffs"))
        self.gridLayout.addWidget(self.generateCoeffs, 1, 1, 1, 1)
        ...
        self.verticalLayout.addWidget(self.highLevelInputsLabel)
        self.topLevelParams = QtGui.QFormLayout()
        ...
        self.wavelengthLabel = QtGui.QLabel(LaserInterface)
        ...
        self.waistSize = QtGui.QLineEdit(LaserInterface)
        self.waistSize.setToolTip(_fromUtf8(""))
        ...
        self.waistPositionLabel = QtGui.QLabel(LaserInterface)
        ...
        self.waistSizeLabel = QtGui.QLabel(LaserInterface)
        ...
        self.wavelength = QtGui.QLineEdit(LaserInterface)
        self.wavelength.setToolTip(_fromUtf8(""))
        ...
        self.waistPosition = QtGui.QLineEdit(LaserInterface)
        self.waistPosition.setToolTip(_fromUtf8(""))
        ...
        self.verticalLayout.addLayout(self.topLevelParams)
        ...
        self.verticalLayout_2.addWidget(self.unitsLabel)
        self.units = QtGui.QFormLayout()
        self.units.setFieldGrowthPolicy(QtGui.QFormLayout.AllNonFixedFieldsGrow)
        self.units.setObjectName(_fromUtf8("units"))
        self.unitsXYLabel = QtGui.QLabel(LaserInterface)
        self.unitsXYLabel.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        ...
        self.verticalLayout_3.addWidget(self.ghTable)
        ...
        self.verticalLayout_4.addWidget(self.zxPlot)
        ...
        self.horizontalLayout_2.addWidget(self.xyPlot)
        ...
        LaserInterface.setTabOrder(self.generatePulse, self.unitsXY)
    ...
    def retranslateUi(self, LaserInterface):
        ...
        self.noTitles.setText(_translate("LaserInterface", "Toggle Plot Titles", None))
        self.generatePulse.setText(_translate("LaserInterface", "Generate Pulse", None))
        self.externalFields.setToolTip(_translate("LaserInterface", "Apply external field to pulse", None))
        self.externalFields.setText(_translate("LaserInterface", "External fields", None))
        self.generateCoeffs.setToolTip(_translate("LaserInterface", "Determine Gauss-Hermite coeffiecients for the current pulse", None))
        ...
        self.wavelengthLabel.setText(_translate("LaserInterface", "Wavelength [um]", None))
        self.waistPositionLabel.setText(_translate("LaserInterface", "Waist Position [m]", None))
        self.waistSizeLabel.setText(_translate("LaserInterface", "Waist radius [um]", None))
        ...
        self.ticksLabel.setText(_translate("LaserInterface", "Axis plot ticks", None))
        self.numTicks.setToolTip(_translate("LaserInterface", "Maximum number of plot tick marks", None))
