...
class Ui_bunchInterface(object):
    def setupUi(self, bunchInterface):
        ...
        self.perpTwissLabel.setGeometry(QtCore.QRect(10, 230, 181, 20))
        ...
        self.offsetLabel.setGeometry(QtCore.QRect(10, 470, 71, 20))
        ...
        self.calculateTwiss.setGeometry(QtCore.QRect(10, 40, 101, 23))
        self.calculateTwiss.setObjectName("calculateTwiss")
        self.longTwissLabel = QtGui.QLabel(bunchInterface)
        self.longTwissLabel.setGeometry(QtCore.QRect(10, 370, 161, 20))
        ...
        self.longTwissSpec.setGeometry(QtCore.QRect(300, 360, 41, 20))
        self.longTwissSpec.setObjectName("longTwissSpec")
        self.perpTwissSpec = QtGui.QToolButton(bunchInterface)
        self.perpTwissSpec.setGeometry(QtCore.QRect(300, 220, 41, 20))
