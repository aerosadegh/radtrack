...
and a planar undulator. This tests considers the physical undulator with its
correct transverse focusing.
...
try:
    print 'testing particle motion in a physical undulator field... '
    from RadTrack.ptclmovers.RbBorisVay import RbBorisVay
    from RadTrack.fields.RbPlanarUndulator \
        import RbPlanarUndulator as planarUndulator
    import numpy as np
    ...
    #ax.legend()
    #plt.savefig('laserHeater03Trajectory.png')
    #plt.show()
    #plt.clf()
    ...
    #plt.ylabel(r'$\beta_x$')
    #plt.legend()
    #plt.savefig('laserHeater03Velocity.png')
    #plt.show()
    #plt.clf()
    ...
    #plt.savefig('laserHeater03Gamma.png')
    #plt.show()
    #plt.clf()
    ...
    if failed:
        raise Exception('laserHeater03 has failed')
