...
def laserGradient(ptcl_data, t_data):
    # allocate the array of derivatives 
    ...
    # derivatives of momenta are the Lorentz forces
    nptcl = ptcl_data.size / 6
    for iLoop in range(nptcl):
        derivs[iLoop+1*nptcl] = 0. # tbd
        derivs[iLoop+3*nptcl] = 0. # tbd
        derivs[iLoop+5*nptcl] = 0. # tbd
